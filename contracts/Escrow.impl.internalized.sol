...
contract Escrow_Stacktical {
    ...
    /**
      ...
      */
    function deposit(address payee) internal {
    ...
    /**
      ...
      */
    function withdraw(address payable payee) internal  {
    ...
    function beneficiaryWithdraw(address _wallet) internal onlyOwner {
    ...
    function depositsOf(address _payee) internal view returns(uint) {

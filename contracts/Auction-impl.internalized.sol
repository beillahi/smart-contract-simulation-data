...
contract SimpleAuction_impl {
  ...
  bool internal $shadow$send$status;
  ...
  function PendingReturns() internal view returns (uint)
  {
        return pendingReturns[msg.sender];
  }

  function HighestBidder() internal view returns (address)
  {
    return highestBidder;
  }


  function HighestBid() internal view returns (uint)
  {
    return highestBid;
  }


  function AuctionStatus() internal view returns (bool)
  {
        return ended;
  }
  ...
  */
  function withdraw() internal returns (bool status) {
  ...
  */
  function auctionEnd() internal {
    ...
    // If functions called internally include interaction with internal

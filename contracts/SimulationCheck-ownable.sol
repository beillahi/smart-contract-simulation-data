...
import "/home/beillahi/Desktop/solidity/smart-contract-explorer/resources/contracts/Ownable.spec.internalized.sol";
...
contract SimulationCheck is Ownable_sirin_labs, Ownable {
     ...
     */
    function check$getOwner() public view returns (address impl_ret_0, address spec_ret_0) {
        impl_ret_0 = Ownable_sirin_labs.getOwner();
        spec_ret_0 = Ownable.getOwner();
     ...
     */
    function check$transferOwnership(address newOwner) public {

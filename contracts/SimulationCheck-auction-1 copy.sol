...
contract SimulationCheck is SimpleAuction_impl, SimpleAuction_spec {
     ...
     * @notice precondition spec$Balance >= SimpleAuction_spec.pendingReturns[msg.sender]
     * @notice postcondition impl_ret_0 == spec_ret_0
     */
     ...
     * @notice precondition spec$Balance >= SimpleAuction_spec.highestBid
     */

...
/// notice simulation  Token._totalSupply ==  __verifier_sum_uint(ERC20.balances)
 ...
 /**
 * @notice simulation  __verifier_eq(Token._balances, ERC20_spec.balances)
 * @notice simulation __verifier_eq(Token._allowed, ERC20_spec.allowances)
 */
contract Token {
     ...
     */
    function balance(address owner) internal view returns (uint) {
     ...
     */
    function allowance(address owner, address spender) internal view returns (uint) {
     ...
     * @param addedValue The amount of tokens to increase the allowance by.
       @notice modifies _allowed[msg.sender]
     */
    function increaseAllowance(address spender, uint addedValue) internal {
     ...
     * @param subtractedValue The amount of tokens to decrease the allowance by.
       @notice modifies _allowed[msg.sender]
     */
    function decreaseAllowance(address spender, uint subtractedValue) internal {

...
contract Voting {
  ...
  */
  ...
  mapping (bytes32 => uint8) internal votesReceived;

  /* Solidity doesn't let you pass in an array of strings in the constructor (yet).
  We will use an array of bytes32 instead to store the list of candidates
  */

  bytes32[] internal candidateList;
  ...
  */
   ...
   */
  constructor(bytes32[] memory candidateNames) internal {
  ...
  */
  function voteForCandidate(bytes32 candidate) internal {
    if (validCandidate(candidate) == false) revert();

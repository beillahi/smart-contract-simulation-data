...
contract ERC20_spec {
    ...
    uint256 public constant INITIAL_SUPPLY = 700000000 * 1 ether;



    /** @notice precondition msg.sender != address(0)
        @notice postcondition balances[msg.sender] == INITIAL_SUPPLY
        @notice modifies balances[msg.sender] 
    */
    constructor() public {
         balances[msg.sender] = balances[msg.sender] + INITIAL_SUPPLY;
    }

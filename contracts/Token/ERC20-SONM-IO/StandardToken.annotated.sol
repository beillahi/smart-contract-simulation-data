...
//import './original/ERC20.sol';
import './original/SafeMath-SONM-IO.sol';
 ...
 */
/// @notice simulation __verifier_eq(StandardToken$balances, ERC20_spec$balances) && __verifier_eq(StandardToken$allowed, ERC20_spec$allowances)
contract StandardToken is  SafeMath {
   ...
   */
  function transfer(address to, uint _value) public {
   ...
   */
  function transferFrom(address from, address to, uint _value) public {

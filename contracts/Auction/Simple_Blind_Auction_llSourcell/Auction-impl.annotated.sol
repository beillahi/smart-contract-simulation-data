 ...
 */
/// @notice simulation __verifier_eq(SimpleAuction_impl$beneficiary, SimpleAuction_spec$beneficiary) && __verifier_eq(SimpleAuction_impl$pendingReturns, SimpleAuction_spec$pendingReturns) && __verifier_eq(SimpleAuction_impl$highestBidder, SimpleAuction_spec$highestBidder) && __verifier_eq(SimpleAuction_impl$highestBid, SimpleAuction_spec$highestBid) && __verifier_eq(SimpleAuction_impl$ended, SimpleAuction_spec$ended) && SimpleAuction_impl$auctionStart + SimpleAuction_impl$biddingTime == SimpleAuction_spec$_auctionEnd
